...
includes = '\n'.join([
    '<link rel="stylesheet" href="assets/purchase-experience.css?v=1"/>',
    '<script defer src="assets/purchase-policy.js?v=1"></script>',
    '<script defer src="assets/purchase-experience.js?v=1"></script>'
])
